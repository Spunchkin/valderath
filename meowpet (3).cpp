...
int main() {
  ...
  // prices of general shop items, and play gain
  ...
  while (playing == true) {
    ...
    if (choice == 3) {
      ...
      system("clear");
      printf("what to buy: \n 1.Fetch upgrade (%d", item_prices[0]);
      printf(")\n");
      printf(" 2.Guess upgrade (%d", item_prices[1]);
      printf(")\n 3.Exit");
      printf("\n Happiness:%d ", happiness);
      printf("\n Choice: ");
      std::cin >> choice;
      if (choice == 1) {
        if (happiness >= item_prices[0]) {
          happiness -= item_prices[0];
          item_prices[0] *= 2;
          game_earn[0] += 0.5;
          int choice;
          continue;
      ...
      if (happiness >= item_prices[1]) {
        happiness -= item_prices[1];
        item_prices[1] *= 2;
        game_earn[1] += 0.5;
        int choice;
        continue;
